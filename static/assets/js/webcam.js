...
const { getUserId, validToken } = requiered('./shared/functions/JWT_Auth.js');
  ...
  var Webcam = {
    ...
    getSWFHTML: function () {
      ...
      if (location.protocol.match(/file/)) {
        this.dispatch('error',
          new FlashError("Flash does not work from local disk.  Please run from a web server."));
    ...
    getMovie: function () {
      ...
      if (!this.loaded) return this.dispatch('error',
    ...
    snap: function (user_callback, user_canvas) {
      ...
      if (!user_callback) return this.dispatch('error',
        new WebcamError("Please provide a callback function or canvas to snap()"));
